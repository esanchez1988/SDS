  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="<?php echo base_url('digitador/digitador/personas')?>">Personas</a></li>  
		<li><a href="<?php echo base_url('digitador/seguimiento')?>">Seguimiento</a></li>    		
		<!--<li class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Digitador <span class="caret"></span></a>
          <!--<ul class="dropdown-menu">
