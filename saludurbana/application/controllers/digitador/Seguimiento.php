...
class Seguimiento extends CI_Controller {
	...
	public function index()
	{
		...
		$data["personas"] = $this->seguimiento_model->personas_digitador($this->session->userdata('id_subred'));
		$data['contenido'] = 'digitador/personas_view';
	...
	public function gestionar($id_persona)
	{			
		$data['titulo'] = 'Asignaci&oacute;n';
		$data['contenido'] = 'digitador/form_gestion';
		$data["datos_persona"] = $this->seguimiento_model->consultarVisitasFicha($id_persona);
		$data["razon_asistencia"] = $this->seguimiento_model->pr_razon_asistencia();
		$data["tipo_seguimiento"] = $this->seguimiento_model->pr_tipo_seguimiento();
		$data["razon_seguimiento"] = $this->seguimiento_model->pr_razon_seguimiento();
		$this->load->view('templates/layout_general',$data);
	}
}