...
$(document).ready(function() {
	...
	$("#btn-buscar-asig").click(function() {
	  	nume_iden_consulta = $('#nume_iden_consulta').val(); 
	  	id_gestor = $('#id_gestor').val(); 
        /*alert(rol);
		return false;*/
        $.post(base_url + "admin/cargaDatosAsignacion", {
            nume_iden_consulta: nume_iden_consulta,
            id_gestor: id_gestor
        }, function (data) {
            $("#informacion").html(data);
