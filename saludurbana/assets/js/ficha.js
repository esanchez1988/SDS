...
$(document).ready(function() {
	...
	$("input[name=p1],input[name=p2],input[name=p3],input[name=p4],input[name=p5],input[name=p6],input[name=p7],input[name=p8],input[name=p9],input[name=p10]").click(function () {    
